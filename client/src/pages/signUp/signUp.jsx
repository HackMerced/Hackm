...
axios.get('http://localhost:3001/api/hackers')
	.then((res) => {
		console.log(res);
	})
				...
				<div id="formID">
					<form>
						...
						<div>
							...
							<input type="radio" id="secondYes" name="drone" value="no"></input><span>No</span>
						</div>
						...
						{/* Race/Ethnicity */}
						<div>
							<label>Race/Ethnicity <font color="red">*</font></label>
						...
						{/* T-Shirt Size */}
						<div>
							<label>T-Shirt Size <font color="red">*</font></label>
						...
						{/* MLH Code of Conduct  */}
						<div>
							<h5>I have read and agree to the MLH Code of Conduct. <font color="red">*</font></h5>
